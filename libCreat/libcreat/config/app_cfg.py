# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in libcreat.
...
import libcreat
from libcreat import model, lib
...
base_config.model = libcreat.model
base_config.DBSession = libcreat.model.DBSession
# Configure the authentication backend
base_config.auth_backend = 'sqlalchemy'
# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP
base_config.sa_auth.cookie_secret = "14c0ffd1-5ef3-4ead-9930-856ade7f7f0c"
